...
// Originally copied from: https://github.com/vladikoff/picl-third-party/blob/master/lib/libs/dropbox.js
(function() {
  ...
  Dropbox.Drivers.Firefox = (function(_super) {
    ...
    function Firefox(options) {
      ...
      // XXX: replace this with some real storage solution
      this.ss = {storage: {}};//require("sdk/simple-storage");
      this.storageKey = "dropbox_js_" + this.scope + "_credentials";
    }
    ...
    Firefox.prototype.doAuthorize = function(authUrl, token, tokenSecret, callback) {
      ...
      tab.browser.addEventListener("pageshow", function onload() {
        ...
        if (url.indexOf("about:blank#?") === 0) {
          let path = "oauth_receiver.html#?" + url.split("#?")[1];
